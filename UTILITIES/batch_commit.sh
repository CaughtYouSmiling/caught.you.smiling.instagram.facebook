...
# Get list of untracked files in animalworldlife1_/VIDEOS/
mapfile -t files < <(git ls-files --others --exclude-standard animalworldlife1_/VIDEOS/)

# Filter out animalworldlife1_/VIDEOS/Video_0.mp4
filtered_files=()
for file in "${files[@]}"; do
  if [[ "$file" != "animalworldlife1_/VIDEOS/Video_0.mp4" ]]; then
    filtered_files+=("$file")
  fi
done
